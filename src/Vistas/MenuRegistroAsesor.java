...
public class MenuRegistroAsesor extends javax.swing.JFrame {
    ...
    private void BotonContinuar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonContinuar
        ...
        String nombreIngresado = jTextField3.getText();
        String apellidoIngresado = jTextField1.getText();
        String usuarioIngresado = jTextField6.getText();
        String contraseñaIngresada = jTextField8.getText();
        
        Asesor asesor = new Asesor(nombreIngresado,apellidoIngresado,usuarioIngresado,contraseñaIngresada);
